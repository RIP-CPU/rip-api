...
CREATE TABLE security.sec_r_user_nurse (
	user_uuid varchar(36) NOT NULL,
	nurse_id varchar(50) NOT NULL
);
CREATE TABLE security.sec_r_user_patient (
	user_uuid varchar(36) NOT NULL,
	patient_id varchar(50) NOT NULL
);
CREATE TABLE security.sec_r_user_physician (
	user_uuid varchar(36) NOT NULL,
	physician_id varchar(50) NOT NULL
);
CREATE TABLE security.sec_r_user_radiographer (
	user_uuid varchar(36) NOT NULL,
...
ALTER TABLE security.sec_r_user_nurse
	ADD FOREIGN KEY (user_uuid) 
	REFERENCES security.sec_user (user_uuid);

ALTER TABLE security.sec_r_user_patient
	ADD FOREIGN KEY (user_uuid) 
	REFERENCES security.sec_user (user_uuid);

ALTER TABLE security.sec_r_user_physician
	ADD FOREIGN KEY (user_uuid) 
	REFERENCES security.sec_user (user_uuid);

ALTER TABLE security.sec_r_user_radiographer
	ADD FOREIGN KEY (user_uuid) 
	REFERENCES security.sec_user (user_uuid);
